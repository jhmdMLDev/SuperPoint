...
def get_args():
    ...
    parser.add_argument(
        "--save_path",
        type=str,
        default=r"C:\Users\Iman\Desktop\Dataset\SVOregcomparison",
    )
    ...
    cfg.data_path = os.path.join(
        r"C:\Users\Iman\Desktop\Dataset\Floater Data\Dataset_eval", f"{args.data_path}"
    )
...
def test_annotations(cfg):
    out = cv2.VideoWriter(
        r"C:\Users\Iman\Desktop\Model_inference/test_reg.mp4",
