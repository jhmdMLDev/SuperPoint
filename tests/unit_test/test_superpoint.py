...
class SuperpointTest(unittest.TestCase):
    def setUp(self):
        ...
        self.superpoint = ApplySuperPointReg(image, model_path)
    ...
    def test_identity_transformation(self):
        for image_path in self.images_paths:
            ...
            # test homography
            assert_homography_close(self.superpoint.H_transform, M_inv)
            # test image
            save_path = (
                self.vis_path
